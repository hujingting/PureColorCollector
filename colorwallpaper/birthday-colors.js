document.addEventListener('DOMContentLoaded', function() {
    ...
    const birthdayColors = {
        ...
        '八月': [
            ...
            { name: "藤鼠", desc: "审视自身存在的浪漫主义者", hex: "#a6a5c4", month: 2, day: 12 },
            { name: "白郡", desc: "性格坚强，值得信赖和尊重的人", hex: "#83ccd2", month: 2, day: 13 },
            { name: "勿忘我", desc: "优美的声音，令人心旷神怡", hex: "#4cb8e7", month: 2, day: 14 },
            { name: "黄色", desc: "在温暖的爱的包围下长大的聪明人", hex: "#ffd911", month: 2, day: 15 },
            { name: "淡奶油", desc: "通过动作和节奏表达情感的天才", hex: "#fffa9c", month: 2, day: 16 },
            { name: "樱草黄", desc: "拥有丰富多彩童年的纯真女孩", hex: "#fff97d", month: 2, day: 17 },
            { name: "柑子色", desc: "重视精神的智者", hex: "#f6ad49", month: 2, day: 18 },
            { name: "金橙", desc: "骄傲自大，追求第一", hex: "#f79101", month: 2, day: 19 },
            { name: "蜜柑色", desc: "身心健康的现实主义者", hex: "#f08300", month: 2, day: 20 },
            { name: "肉桂色", desc: "能够带来平衡并使整个团队团结起来的领导者", hex: "#dd7a56", month: 2, day: 21 },
            { name: "金玉米", desc: "独特而开朗的人", hex: "#ffcc83", month: 2, day: 22 },
            { name: "深向日葵", desc: "能够从两面看待事物的创作者", hex: "#feae01", month: 2, day: 23 },
            { name: "黄赭石", desc: "努力工作，不断提升自己", hex: "#c4972f", month: 2, day: 24 },
            { name: "浅黄色", desc: "有礼貌、重视人际关系的人", hex: "#caac71", month: 2, day: 25 },
            { name: "烟草色", desc: "想要占上风的领导者", hex: "#7d541c", month: 2, day: 26 },
            { name: "天蓝色", desc: "浪漫，可与任何服装搭配", hex: "#a0d8ee", month: 2, day: 27 },
            { name: "水灰色", desc: "希望在任何领域发挥主导作用的创作者", hex: "#5d9cbf", month: 2, day: 28 },
            { name: "淡蓝色鼠尾草", desc: "谨慎，擅长社交", hex: "#4b7cb6", month: 2, day: 29 },
            { name: "群青战士", desc: "富有同情心的人，其旋律触动人心弦", hex: "#356cac", month: 2, day: 30 },
            { name: "紫绀", desc: "高高在上的意见领袖", hex: "#460e44", month: 2, day: 31 }
        ],
        // 九月
        '九月': [
