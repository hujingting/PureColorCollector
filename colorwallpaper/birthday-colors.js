document.addEventListener('DOMContentLoaded', function() {
    ...
    const birthdayColors = {
        ...
        '五月': [
            ...
            { name: "孔雀石绿", desc: "天生善于社交但不喜欢噪音的人", hex: "#009854", month: 2, day: 2 },
            { name: "青绿色", desc: "向往清澈溪水和耕地的田园牧歌", hex: "#01686d", month: 2, day: 3 },
            { name: "小鸭色", desc: "掌握公平、诚实胜利关键的人", hex: "#014127", month: 2, day: 4 },
            { name: "浅蓝色", desc: "能将想法变成现实的艺术家", hex: "#bce2e8", month: 2, day: 5 },
            { name: "勿忘我坚果蓝", desc: "展现才华的同时又保留女性气质的人", hex: "#70c6f5", month: 2, day: 6 },
            { name: "群青色", desc: "麦当娜知道自己的长处，并因此受到称赞", hex: "#4c6cb3", month: 2, day: 7 },
            { name: "绿千岁", desc: "麦当娜知道自己的长处，并因此受到称赞", hex: "#316745", month: 2, day: 8 },
            { name: "长尾小鹦鹉绿", desc: "和谐平衡、活跃", hex: "#2cb232", month: 2, day: 9 },
            { name: "蛋壳", desc: "值得信赖的人，不会轻易陷入爱情", hex: "#f5f6ca", month: 2, day: 10 },
            { name: "生菜绿", desc: "敢于接受新挑战、做好失败准备的挑战者", hex: "#d1de4c", month: 2, day: 11 },
            { name: "黄绿色", desc: "真诚又善于社交的人", hex: "#e3e548", month: 2, day: 12 },
            { name: "枯草色", desc: "有才华，能准确表达自己的想法", hex: "#e4dc8a", month: 2, day: 13 },
            { name: "橄榄绿", desc: "热爱花草并懂得种植花草乐趣的自然主义者", hex: "#72640c", month: 2, day: 14 },
            { name: "殖民地黄", desc: "雄心勃勃、不断努力获取知识的人", hex: "#d0c67c", month: 2, day: 15 },
            { name: "淡芥末", desc: "坚强、固执、技术娴熟的人", hex: "#a49627", month: 2, day: 16 },
            { name: "金赭石", desc: "固执，不愿在自己的观点上妥协", hex: "#8d6f2f", month: 2, day: 17 },
            { name: "橄榄茶", desc: "知识渊博、温和", hex: "#464646", month: 2, day: 18 },
