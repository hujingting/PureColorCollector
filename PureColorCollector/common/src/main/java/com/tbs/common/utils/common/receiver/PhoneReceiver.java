package com.tbs.common.utils.common.receiver;
...
import com.tbs.common.utils.common.assist.CheckEmpty;
...
public class PhoneReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (NEW_OUTGOING_CALL.equals(intent.getAction())) {
            ...
            if (!CheckEmpty.INSTANCE.isEmpty(outNumber)) {
            ...
            if (!CheckEmpty.INSTANCE.isEmpty(inNumber)) {
